...
y3_hat=best_gbr_model.predict(train_x) 
...
pred_y_gbr=best_gbr_model.predict(test_x) # test 셋에 대한 집값
...
# # csv 파일로 내보내기
sub_df.to_csv("sample_submission_stack6.csv", index=False)